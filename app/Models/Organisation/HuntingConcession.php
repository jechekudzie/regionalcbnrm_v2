...
use App\Models\Organisation\Safari;
...
class HuntingConcession extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Admin\Organisation::class,'safari_id');
    }

    public function wards() // Wards covered by the concession
    {
        return $this->belongsToMany(\App\Models\Admin\Organisation::class, 'hunting_concession_ward', 'hunting_concession_id', 'ward_id');
    }
