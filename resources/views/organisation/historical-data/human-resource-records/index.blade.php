    ...
    <div class="container-fluid px-4">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('human_resource_records.create', $organisation) }}" class="btn btn-primary btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('human_resource_records.show', [$organisation, $record]) }}" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('human_resource_records.edit', [$organisation, $record]) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('human_resource_records.destroy', [$organisation, $record]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                @csrf
                                                @method('DELETE')
