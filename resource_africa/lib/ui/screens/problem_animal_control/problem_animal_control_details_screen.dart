              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Lat: ${control.latitude.toStringAsFixed(6) ?? 'Unknown'}, Lng: ${control.longitude.toStringAsFixed(6) ?? 'Unknown'}',
                        style: const TextStyle(
                          fontSize: 14,
                      ...
                      SizedBox(
                        ...
                        child: LocationMapView(
                          latitude: control.latitude ?? 0.0,
                          longitude: control.longitude ?? 0.0,
                        ),
                      ),
                    ],
                  ),
